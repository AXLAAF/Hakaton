...
La evaluación de la correctitud, seguridad y mantenibilidad de los artefactos de desarrollo (A3 y A4) se evalúa rigurosamente basándose en el estándar de calidad de software **ISO/IEC 25010**. Por otro lado, los artefactos de planificación y diseño (A1 y A2) son auditados de acuerdo con el **SWEBOK v3.0** (Software Engineering Body of Knowledge).
